...
function App() {
  ...
  <header id="header" className="fixed-top ">
    <div className="container d-flex align-items-center">
      ...
      <h1 className="logo"><a href="index.html">Citra Sanxing Indonesia</a></h1>
  ...
  <section id="hero">
    <div id="heroCarousel" className="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div className="carousel-inner" role="listbox">
        {/* Slide 1 */}
        <div className="carousel-item active" style={{backgroundImage: 'url(assets/img/slide/slider-1.jpg)'}}>
        ...
        {/* Slide 2 */}
        <div className="carousel-item" style={{backgroundImage: 'url(assets/img/slide/slider-2.jpg)'}}>
          <div className="carousel-container">
            <div className="container">
        ...
        {/* Slide 3 */}
        <div className="carousel-item" style={{backgroundImage: 'url(assets/img/slide/slider-3.jpg)'}}>
          <div className="carousel-container">
            <div className="container">
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/pln.png" className="img-fluid" alt />
          </div>
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/amartha.png" className="img-fluid" alt />
          </div>
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/gps.png" className="img-fluid" alt />
          </div>
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/sudirmansuites.png" className="img-fluid" alt />
          </div>
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/aff.png" className="img-fluid" alt />
          </div>
          <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/wikaenergy.png" className="img-fluid" alt />
          </div>
        </div>
      </div>
        ...
        <div className="row portfolio-container">
          <div className="col-lg-4 col-md-6 portfolio-item filter-prepaid">
            <div className="portfolio-wrap">
              <img src="assets/img/product/sx1ad.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>SX1A0</h4>
                <p>Meter 1phase Prabayar Generation one</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/sx1ad.png" data-gall="portfolioGallery" className="venobox" title="SX1A0"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-prepaid">
            <div className="portfolio-wrap">
              <img src="assets/img/product/p12a4.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>P12A4</h4>
                <p>Meter 1phase Prabayar Generation Two</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/p12a4.png" data-gall="portfolioGallery" className="venobox" title="P12A4"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-prepaid">
            <div className="portfolio-wrap">
              <img src="assets/img/product/csi11.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>CSI11</h4>
                <p>Meter 1phase Prabayar Generation Three</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/csi11.png" data-gall="portfolioGallery" className="venobox" title="CSI11"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-postpaid">
            <div className="portfolio-wrap">
              <img src="assets/img/product/csi01.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>CSI01</h4>
                <p>Meter 1phase Postpaid Generation One</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/csi01.png" data-gall="portfolioGallery" className="venobox" title="CSI01"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-postpaid">
            <div className="portfolio-wrap">
              <img src="assets/img/product/csi32.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>CSI32</h4>
                <p>Meter 3Phase Postpaid AMR kWh Meter</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/csi32.png" data-gall="portfolioGallery" className="venobox" title="CSI32"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-modem">
            <div className="portfolio-wrap">
              <img src="assets/img/product/3GModem.jpg" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>CSI21</h4>
                <p>3G Modem Communication</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/3GModem.jpg" data-gall="portfolioGallery" className="venobox" title="CSI21"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-modem">
            <div className="portfolio-wrap">
              <img src="assets/img/product/4GModem.jpg" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>CSI21-S</h4>
                <p>4G Modem Communication</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/4GModem.jpg" data-gall="portfolioGallery" className="venobox" title="CSI21-S"><i className="bx bx-plus" /></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-vending">
            <div className="portfolio-wrap">
              <img src="assets/img/product/vending2.png" className="img-fluid" alt />
              <div className="portfolio-info">
                <h4>Vending System</h4>
                <p>Sanplat Prepayment Vending System STS 1phase</p>
                <div className="portfolio-links">
                  <a href="assets/img/product/vending2.png" data-gall="portfolioGallery" className="venobox" title="Vending System"><i className="bx bx-plus" /></a>
